...
//			tela.click(vpn6);
			...
			tela.wait("C:\\Sikuli\\WinSCP\\2.PNG", 15000L);
			tela.doubleClick(win2);
			tela.wait("C:\\Sikuli\\WinSCP\\8.PNG", 15000L);
			tela.type("ellow08" + Key.ENTER);
			tela.wait("C:\\Sikuli\\WinSCP\\11.PNG", 15000L);
			Thread.sleep(1500L);
			tela.type("p", Key.CTRL);
			Pattern win3 = new Pattern("C:\\Sikuli\\WinSCP\\3.PNG");
			tela.wait("C:\\Sikuli\\WinSCP\\3.PNG", 15000L);
			tela.click(win3);
			tela.wait("C:\\Sikuli\\WinSCP\\9.PNG", 15000L);
			tela.type("ellow08" + Key.ENTER);
			tela.wait("C:\\Sikuli\\WinSCP\\10.PNG", 15000L);
			...
			tela.wait("C:\\Sikuli\\WinSCP\\5.PNG");
